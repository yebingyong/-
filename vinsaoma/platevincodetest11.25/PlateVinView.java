...
public class PlateVinView extends CameraPreview {
   ...
   */
  public void decodeSingle(PlateVinCallback callback,PlateApi plateApi) {
  ...
  private void startDecoderThread() {
    ...
    if (decodeMode != PlateVinView.DecodeMode.NONE && isPreviewActive()) {
      ...
      decoderThread = new DecoderThread(getCameraInstance(), createDecoder(), resultHandler,plateApi);
