 ...
 */
package cn.mancando.cordovaplugin.platevincodetest.camera;
...
public final class CameraManager {
  ...
  private static final String TAG = com.journeyapps.barcodescanner.camera.CameraManager.class.getSimpleName();
  ...
  public void startPreview() {
    ...
    if (theCamera != null && !previewing) {
      ...
      ambientLightManager = new AmbientLightManager(context, new com.journeyapps.barcodescanner.camera.CameraManager(this.context), settings);
