...
public class CameraPreview extends ViewGroup {
  ...
  private List<com.journeyapps.barcodescanner.CameraPreview.StateListener> stateListeners = new ArrayList();
   ...
   */
  public void addStateListener(com.journeyapps.barcodescanner.CameraPreview.StateListener listener) {
    stateListeners.add(listener);
  }

  private final com.journeyapps.barcodescanner.CameraPreview.StateListener fireState = new com.journeyapps.barcodescanner.CameraPreview.StateListener() {
    @Override
    public void previewSized() {
      for (com.journeyapps.barcodescanner.CameraPreview.StateListener listener : stateListeners) {
