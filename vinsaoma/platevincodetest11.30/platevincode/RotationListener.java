...
public class RotationListener {
  ...
  private cn.mancando.cordovaplugin.platevincodetest.platevincode.RotationCallback callback;

  public RotationListener() {
  }


  public void listen(Context context, cn.mancando.cordovaplugin.platevincodetest.platevincode.RotationCallback callback) {
    ...
    this.orientationEventListener = new OrientationEventListener(context, SensorManager.SENSOR_DELAY_NORMAL) {
      ...
      public void onOrientationChanged(int orientation) {
        ...
        RotationCallback localCallback = cn.mancando.cordovaplugin.platevincodetest.platevincode.RotationListener.this.callback;
